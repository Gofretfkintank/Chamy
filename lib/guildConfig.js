...
const KEYS = {
    ...
    'staff:jailPreservedRole': {
        kind: 'role', label: 'Role kept through /jail',
        help: 'A member who has this role keeps it when jailed; every other role is stripped.'
    },
    'staff:extraOwners': {
    ...
    'aether:adminRoles': {
        kind: 'role', list: true, label: 'Aether admin roles',
        help: 'Roles allowed to administer Aether sessions, profiles and sanctions.'
    },
    'aether:startRoles': {
        kind: 'role', list: true, label: 'Aether start roles',
        help: 'Roles allowed to start and schedule Aether sessions.'
    },
