...
const LEGACY_VALUES = {
    ...
    'staff:jailPreservedRole'   : '1487415507031167176', // quarantina.js — survives /jail
...
// Shared, run-once. Several 'ready' listeners read the home guild's config,
// and the event files are loaded — so their 'ready' fires — BEFORE the one in
// index.js. On the first boot after this change, a listener that read config
// without awaiting this would find nothing and silently not start until the
// next restart. Anything that reads config at startup awaits this first.
let seedPromise = null;
function seedLegacyGuild() {
