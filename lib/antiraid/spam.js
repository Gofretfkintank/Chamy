...
async function onMessage(message) {
    ...
    // Spam kurali tetiklendi; icerikte raid imzasi (link, "raided by", "X is the best")
    // varsa troll degil, raid say.
    if (!raid && (RAID_PHRASE.test(content) || LINK.test(content))) raid = true;
